...
O projeto vem sendo desenvolvido de forma incremental ao longo das aulas, aplicando conceitos de React Native, componentes, gerenciamento de estado, listas e integração com APIs REST.
...
## Aula 2 e Aula 3 — Proposta e Primeiro MVP
...
![Validação de preenchimento](tela-erro.png)

----------------------------------------------------------------------------

## Aula 4 — Componentes, Estado e Listas

Na Aula 4, o projeto foi reorganizado e foram aplicados conceitos importantes do React Native.
...
![Lista de produtos da Aula 4](aula4-lista-produtos.png)

## Remoção de produtos

![Remoção de produtos da Aula 4](aula4-remover-produto.png)
...
A API escolhida foi a ViaCEP, pois a consulta de endereço possui relação com a proposta do Menor Preço Saqua.
...
![Consulta de CEP](aula5-consulta-cep.png)

## Endereço encontrado pela ViaCEP

![Endereço encontrado pela ViaCEP](aula5-endereco-encontrado.png)

## Produto cadastrado com localização

![Produto com preço e localização](aula5-produto-localizacao.png)
...
Etapa - Aulas 2 e 3  /  Desenvolvimento - Definição do problema, proposta e desenvolvimento do primeiro MVP

Etapa - Aula 4  /  Desenvolvimento - useState, TextInput, validações, FlatList, remoção e componente reutilizável

Etapa - Aula 5  /  Desenvolvimento - Integração com API REST ViaCEP, requisição GET, JSON, loading e tratamento de erros
